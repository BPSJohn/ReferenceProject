package com.example.android.simpsonfortniteproject.ui.geofencing
...
import com.example.android.simpsonfortniteproject.BuildConfig
import com.example.android.simpsonfortniteproject.R
import com.example.android.simpsonfortniteproject.util.SharedPreferenceUtil
import com.example.android.simpsonfortniteproject.util.toText
...
class GeofencingActivity : AppCompatActivity(),
    ...
    private fun requestForegroundPermissions() {
        ...
        if (provideRationale) {
            Snackbar.make(
                findViewById(R.id.geofencing_activity),
